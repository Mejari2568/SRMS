...
class studentClass:
    def __init__(self,root):
        ...
        lbl_contact=Label(self.root,text="Contacts",font=("goudy old style",15,'bold'),bg='white').place(x=360,y=100)
        ...
        self.btn_update=Button(self.root,text='update',font=("goudy old style",15,"bold"),bg="#4caf50",cursor="hand2",command=self.update)
        self.btn_update.place(x=270,y=400,width=110,height=40)
        self.btn_delete=Button(self.root,text='delete',font=("goudy old style",15,"bold"),bg="#f44336",cursor="hand2",command=self.delete)
        self.btn_delete.place(x=390,y=400,width=110,height=40)
        self.btn_clear=Button(self.root,text='clear',font=("goudy old style",15,"bold"),bg="#607d8b",cursor="hand2",command=self.clear)
