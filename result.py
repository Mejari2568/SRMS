...
class resultClass:
    def __init__(self,root):
       ...
       txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",20, "bold"),bg='white',state='readonly').place(x=280,y=160,width=320)
       txt_course=Entry(self.root,textvariable=self.var_course,font=("goudy old style",20, "bold"),bg='white',state='readonly').place(x=280,y=220,width=320)
